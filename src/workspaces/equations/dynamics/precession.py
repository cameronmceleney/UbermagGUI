...
class PrecessionTerm(_PanelBase):
    """
    Create a test panel for the Dynamics feature.

    Attributes
    ----------
    btn_define : widgets.Button
        Button to signal that callbacks should take place to define a ``micromagneticmodel.Precession()`` term.
    """
    ...
    def _assemble_panel(self, children: typing.List[widgets.Widget]) -> None:
        ...
        children.append(widgets.HTML("<b>Define a Precession DynamicsTerm.</b>"))
    ...
    def _on_define(self, _):
        ...
        """
        logger.debug("PrecessionTerm._on_define called.")
        ...
        logger.success("PrecessionTerm: call complete.")
